...
export const PUZZLE_PACKS: PuzzlePack[] = [
  {
    ...
    icon: '🌴',
    description: '14 destinations in one hunt',
    category: 'travel',
    color: '#0284c7',
    coverGradient: 'linear-gradient(135deg, #0c4a6e 0%, #38bdf8 50%, #0284c7 100%)',
    puzzleCount: 1,
  },
  {
    id: 'stadiums',
    name: 'Stadiums',
    icon: '🏟️',
    description: '16 stadiums in one hunt',
    category: 'sports',
    color: '#15803d',
    coverGradient: 'linear-gradient(135deg, #14532d 0%, #4ade80 50%, #15803d 100%)',
    puzzleCount: 1,
  },
  {
    id: 'pet-names',
    name: 'Pet names',
    icon: '🐾',
    description: '19 pet names in one hunt',
    category: 'animals',
    color: '#d97706',
    coverGradient: 'linear-gradient(135deg, #92400e 0%, #fbbf24 50%, #d97706 100%)',
    puzzleCount: 1,
  },
  {
    ...
    icon: '👨‍👩‍👧‍👦',
    description: '15 family names in one hunt',
    category: 'kids',
    color: '#db2777',
    coverGradient: 'linear-gradient(135deg, #9d174d 0%, #f9a8d4 50%, #db2777 100%)',
    puzzleCount: 1,
  },
  {
    id: 'ocean-creatures',
